---
layout: post
title: 7-week Class on Browser Programming with Clojurescript
---

So you've learned the fundamentals of web development, but now you want to make beautiful, interactive UIs? 

It's time to break out browser programming and Clojurescript.
...
<form action="//gargoyle.us4.list-manage.com/subscribe/post?u=8cccbb825d8db3c9a6f244242&amp;id=5a387327bb&amp;CLASS=Clojurescript" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
